...
//
//    private List<CourseData> allCourses; // Store all courses in memory
//
//    public ExcelReader() {
//        allCourses = new ArrayList<>();
//    }
//
//    // Read Excel file and print data one by one
...
//                String course = getValue(row, 2);
//                String dept = getValue(row, 3);
//                String section = getValue(row, 4);
//                String title = getValue(row, 5);
//                String days = getValue(row, 7);
//                String startTime = getValue(row, 8);
//                String endTime = getValue(row, 9);
//                String building = getValue(row, 10);
//                String room = getValue(row, 11);
//
//                if (!crn.isEmpty()) {
...
//                    CourseData courseData = new CourseData(crn, course, dept, section,
...
//    }
//
//    // Filter courses by CRN list
//    public List<CourseData> getCoursesByCRNs(String[] crns) {
//        List<CourseData> filtered = new ArrayList<>();
//
//        for (String crn : crns) {
//            crn = crn.trim();
//            for (CourseData course : allCourses) {
...
//    }
//
//    // Filter courses by day (U, M, T, W, R)
//    public List<CourseData> filterByDay(List<CourseData> courses, String day) {
//        List<CourseData> filtered = new ArrayList<>();
//
...
//    }
//
//    // If cell has value, return it. If empty/null, return empty string
