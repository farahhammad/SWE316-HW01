...
public class Building {
    ...
    private static final Map<String, Point> buildingCoordinates;
    ...
    public Building(String buildingNumber) {
        this.buildingNumber = (buildingNumber == null || buildingNumber.isBlank()) ? "N/A" : buildingNumber.trim();
        this.location = buildingCoordinates.getOrDefault(this.buildingNumber, new Point(0, 0));
    }
